...
exports.sendResetOTP = exports.sendOTPVerificationEmail = void 0;
...
const sendOTPVerificationEmail = (email, otp) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const sendResetOTP = (email, otp) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const transporter = nodemailer_1.default.createTransport(Object.assign({}, MAIL_CONFIG));
        const mailOptions = {
            from: process.env.AUTH_EMAIL,
...
exports.default = exports.sendOTPVerificationEmail;
