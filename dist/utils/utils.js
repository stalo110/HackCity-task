...
exports.updateProfilePictureSchema = joi_1.default.object().keys({
    image: joi_1.default.binary().encoding('base64').required(),
});
exports.uploadProfilePictureSchema = joi_1.default.object().keys({
    image: joi_1.default.binary().encoding('base64').required(),
});
